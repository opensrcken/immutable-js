...
export module List {
   ...
   */
  export function isList(maybeList: any): boolean;

  /**
   * Creates a new List containing `values`.
   */
  export function of<T>(...values: T[]): List<T>;
}
...
export module Set {
   ...
   */
  export function isSet(maybeSet: any): boolean;

  /**
   * Creates a new Set containing `values`.
   */
  export function of<T>(...values: T[]): Set<T>;

  /**
   * `Set.fromKeys()` creates a new immutable Set containing the keys from
   * this Iterable or JavaScript Object.
   */
  export function fromKeys<T>(iter: Iterable<T, any>): Set<T>;
  export function fromKeys(obj: {[key: string]: any}): Set<string>;
}
...
export module OrderedSet {
   ...
   */
  export function isOrderedSet(maybeOrderedSet: any): boolean;

  /**
   * Creates a new OrderedSet containing `values`.
   */
  export function of<T>(...values: T[]): OrderedSet<T>;

  /**
   * `OrderedSet.fromKeys()` creates a new immutable OrderedSet containing
   * the keys from this Iterable or JavaScript Object.
   */
  export function fromKeys<T>(iter: Iterable<T, any>): OrderedSet<T>;
  export function fromKeys(obj: {[key: string]: any}): OrderedSet<string>;
}
...
export module Stack {
   ...
   */
  export function isStack(maybeStack: any): boolean;

  /**
   * Creates a new Stack containing `values`.
   */
  export function of<T>(...values: T[]): Stack<T>;
}
...
export module Seq {
   ...
   */
  export function isSeq(maybeSeq: any): boolean;

  /**
   * Returns a Seq of the values provided. Alias for `Seq.Indexed.of()`.
   */
  export function of<T>(...values: T[]): Seq.Indexed<T>;
  ...
  export module Set {
     ...
     */
    export function of<T>(...values: T[]): Seq.Set<T>;
  }
...
export module Iterable {
   ...
   */
  export function isIterable(maybeIterable: any): boolean;
